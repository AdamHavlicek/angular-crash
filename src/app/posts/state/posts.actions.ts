...
export const ADD_POST_START = '[posts page] add post start';
export const ADD_POST_SUCCESS = '[posts page] add post success';
export const UPDATE_POST_START = '[posts page] update post start';
export const UPDATE_POST_SUCCESS = '[posts page] update post success';
export const DELETE_POST_START = '[posts page] delete post start';
